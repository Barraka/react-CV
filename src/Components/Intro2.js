        ...
        <div className="section">
                <div className="subsection">
                    <div className="introLeft">
                        ...
                        <input type="file"  accept="image/*" name="image" id="file" className='chooseFile' onChange={loadFile}></input>
                ...
                <div className="submitButton incomplete">
                    <button onClick={addtocv}>Confirm</button>
                </div>
            </div>
    )
}
